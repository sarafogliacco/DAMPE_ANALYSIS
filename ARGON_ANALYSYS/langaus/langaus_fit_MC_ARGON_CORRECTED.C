...
void langaus_fit_MC_ARGON_CORRECTED(){

   TFile *f = new TFile("../out_root/MC_FTFP_ARGON_SATcorr_STKcut1200_PSDcutXY_CORRECTED.root");
   ...
   if(j==1) {fr[0]=17.5; fr[1]=19.0;}
   if(j==2) {fr[0]=17.6; fr[1]=19.0;}
   if(j==3) {fr[0]=17.6; fr[1]=19.0;}
   if(j==4) {fr[0]=17.6; fr[1]=19.2;}
   if(j==5) {fr[0]=17.6; fr[1]=19.2;}
   if(j==6) {fr[0]=17.6; fr[1]=19.2;}
   if(j==7) {fr[0]=17.6; fr[1]=19.2;}
   if(j==8) {fr[0]=17.6; fr[1]=19.3;}
   if(j==9) {fr[0]=17.6; fr[1]=19.4;}
   if(j==10){fr[0]=17.6; fr[1]=20.0;}
   ...
   */
   ...
   printf("Fitting done\nPlotting results...\n");
    ...
    xxx->GetYaxis()->SetTitleOffset(1.3); xxx->GetXaxis()->SetRangeUser(17.,20.5);
...
/**/
   ofstream fout;
   fout.open("langaus_results/langaus_fit_MC_ARGON_STKcut1200_PSDcutXY_CORRECTED.txt",ios::app);
