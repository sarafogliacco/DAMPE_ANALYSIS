...
root_files = [
    "unfold_results_SULFUR_6bin_HET+fiducial_volume_2e7.root",
    "unfold_results_SULFUR_6bin_STK_2e7.root",
    "unfold_results_SULFUR_6bin_PSD_2e7.root",
    "unfold_results_SULFUR_6bin_2e7_2e5sigma.root"
]
...
for filename in root_files:
    ...
    label = ["HET+fiducial volume cut", "STK cut", "PSD cut", "charge cut"][root_files.index(filename)]
