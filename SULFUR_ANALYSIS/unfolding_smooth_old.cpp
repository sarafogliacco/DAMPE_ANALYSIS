...
int unfolding_smooth() {
    ...
    std::string response_file = "load/out_load/Out_MC_FTFP_S_E2e7_6bin_500TeV_new.root";
    std::string response_histo = "h2Ntrig_wgt";
    std::string data_file = "load/out_load/Out_DATA_120months_SULFUR_6bin_v2.root"; 
...
*/
    ...
    // Save data
    std::ofstream txtout("data/flux_pow_SULFUR_6bin_2e7_new.txt");
    if(!txtout.is_open()){
    ...
    */
    ...
    // Save output
    TString fout_name = "unfold_results/unfold_results_SULFUR_6bin_2e7_new.root";
