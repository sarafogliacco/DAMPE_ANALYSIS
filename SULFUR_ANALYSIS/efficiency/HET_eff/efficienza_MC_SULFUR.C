...
void efficienza_MC_SULFUR(){
    /////  HIST ////
    TFile aa("out_eff/HET_eff_MC_FTFP_SULFUR_8bin.root");
    aa.ls();
    ...
    //double nnum[nbin_data], nden[nbin_data], W[nbin_data], DEN[nbin_data], epsilon[nbin_data];   
    ...
    TFile *f = TFile::Open("out_eff/eff_HET_MC_SULFUR_8bin.root", "RECREATE");
    f->cd();
