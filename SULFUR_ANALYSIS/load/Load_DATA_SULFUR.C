{
        ...
        */
        ...
        //"(15.0798+(0.966632*log10(BGO_EnergyG_SatCorr_ML_ions))+(-0.293964*pow(log10(BGO_EnergyG_SatCorr_ML_ions),2))+(0.0322678*pow(log10(BGO_EnergyG_SatCorr_ML_ions),3)))";
        //"(15.9434+(0.0730006*log10(BGO_EnergyG_SatCorr_ML_ions))+(0.00533945*pow(log10(BGO_EnergyG_SatCorr_ML_ions),2))+(-0.000744557*pow(log10(BGO_EnergyG_SatCorr_ML_ions),3)))";
        //"(14.6412+(1.46648*log10(BGO_EnergyG_SatCorr_ML_ions))+(-0.475708*pow(log10(BGO_EnergyG_SatCorr_ML_ions),2))+(0.0528252*pow(log10(BGO_EnergyG_SatCorr_ML_ions),3)))";
        ...
        //"(0.33239+(-0.0579834*log10(BGO_EnergyG_SatCorr_ML_ions))+(0.0199986*pow(log10(BGO_EnergyG_SatCorr_ML_ions),2)))";
        ...
        TFile *foutp = new TFile("out_load/Out_DATA_120months_SULFUR_6bin.root","RECREATE");
