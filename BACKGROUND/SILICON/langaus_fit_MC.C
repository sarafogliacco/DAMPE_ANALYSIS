...
void langaus_fit_MC(){
   ...
   TFile *f = new TFile("/mnt/c/Users/saraf/Desktop/DAMPE_ANALYSIS/BACKGROUND/out_root/MC_FTFP_SILICON_SATcorr_STKcut1200_PSDcutXY.root");
   ...
   if(j==9) {fr[0]=14.7;   fr[1]=16.0;}
   if(j==10){fr[0]=14.8;   fr[1]=16.6;}
...
/**/
   ofstream fout;
   fout.open("/mnt/c/Users/saraf/Desktop/DAMPE_ANALYSIS/BACKGROUND/langaus_results/langaus_fit_MC_SILICON_STKcut1200_PSDcutXY.txt",ios::app);
