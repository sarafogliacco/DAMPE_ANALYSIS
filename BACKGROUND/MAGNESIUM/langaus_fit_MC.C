...
void langaus_fit_MC(){
   ...
   TFile *f = new TFile("/mnt/c/Users/saraf/Desktop/DAMPE_ANALYSIS/BACKGROUND/out_root/MC_FTFP_MAGNESIUM_SATcorr_STKcut1200_PSDcutXY.root");
   ...
   if(j==1) {fr[0]=12.4; fr[1]=13.15;}
   if(j==2) {fr[0]=12.4; fr[1]=13.2;}
   if(j==3) {fr[0]=12.45; fr[1]=13.25;}
   if(j==4) {fr[0]=12.5; fr[1]=13.3;}
   if(j==5) {fr[0]=12.5; fr[1]=13.3;}
   if(j==6) {fr[0]=12.5; fr[1]=13.4;}
   if(j==7) {fr[0]=12.6; fr[1]=13.4;}
   if(j==8) {fr[0]=12.6; fr[1]=13.5;}
   if(j==9) {fr[0]=12.65; fr[1]=13.8;}
   if(j==10){fr[0]=12.7; fr[1]=14.5;}
   ...
   */
   ...
   printf("Fitting done\nPlotting results...\n");
    ...
    xxx->GetYaxis()->SetTitleOffset(1.3); xxx->GetXaxis()->SetRangeUser(11.8,14.6);
...
/**/
   ofstream fout;
   fout.open("/mnt/c/Users/saraf/Desktop/DAMPE_ANALYSIS/BACKGROUND/langaus_results/langaus_fit_MC_MAGNESIUM_STKcut1200_PSDcutXY.txt",ios::app);
