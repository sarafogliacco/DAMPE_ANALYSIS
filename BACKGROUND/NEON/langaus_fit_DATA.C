...
Int_t langaupro(Double_t *params, Double_t &maxx, Double_t &FWHM) {
   ...
   TFile *f = new TFile("../out_root/Skim_120months_SATcorr_STKcut1200_PSDcutXY_v2.root");
   ...
   if(j==1) {fr[0]=15.8; fr[1]=16.6;}
   if(j==2) {fr[0]=15.80; fr[1]=16.7;}
   if(j==3) {fr[0]=15.8; fr[1]=16.7;}
   if(j==4) {fr[0]=15.80; fr[1]=16.8;} 
   if(j==5) {fr[0]=15.65; fr[1]=17.0;}
   if(j==6) {fr[0]=15.80; fr[1]=17.0;}
   if(j==7) {fr[0]=15.70; fr[1]=16.9;}
   if(j==8) {fr[0]=15.8; fr[1]=17.5;}
...
/**/
   ofstream fout;
   fout.open("langaus_results/langaus_fit_DATA_SULFUR_STKcut1200_PSDcutXY.txt",ios::app);
