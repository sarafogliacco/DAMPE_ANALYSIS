...
void cfr_DATA_MC_mpv(){
    ...
    //ifstream infileMC("/mnt/c/Users/saraf/Desktop/DAMPE_ANALYSIS/BACKGROUND/langaus_results/results_langaus_fit_MC_NEON.txt"); //NEON
    //ifstream infileMC("/mnt/c/Users/saraf/Desktop/DAMPE_ANALYSIS/BACKGROUND/langaus_results/results_langaus_fit_MC_MAGNESIUM.txt"); //MAGNESIUM
    ifstream infileMC("/mnt/c/Users/saraf/Desktop/DAMPE_ANALYSIS/BACKGROUND/langaus_results/results_langaus_fit_MC_SILICON.txt"); //SILICON
    ...
    ///////////////////////////////////// FLIGHT DATA
    //ifstream infileDATA("/mnt/c/Users/saraf/Desktop/DAMPE_ANALYSIS/BACKGROUND/langaus_results/results_langaus_fit_DATA_NEON.txt"); //NEON
    //ifstream infileDATA("/mnt/c/Users/saraf/Desktop/DAMPE_ANALYSIS/BACKGROUND/langaus_results/results_langaus_fit_DATA_MAGNESIUM.txt"); //MAGNESIUM
    ifstream infileDATA("/mnt/c/Users/saraf/Desktop/DAMPE_ANALYSIS/BACKGROUND/langaus_results/results_langaus_fit_DATA_SILICON.txt"); //SILICON
    ...
    gmpv_mc->Draw("p");
    gmpv_mc->Fit("fitMC","r");
    cout << "TString MPV_MC = \"(" << fitMC->GetParameter(0) << "+(" << fitMC->GetParameter(1) << "*log10(BGO_EnergyG_QuenchSatCorr_ML_ions))" << "+(" << fitMC->GetParameter(2) << "*pow(log10(BGO_EnergyG_QuenchSatCorr_ML_ions),2))" << "+(" << fitMC->GetParameter(3) << "*pow(log10(BGO_EnergyG_QuenchSatCorr_ML_ions),3))" << "+(" << fitMC->GetParameter(4) << "*pow(log10(BGO_EnergyG_QuenchSatCorr_ML_ions),4))" << ")\";" << endl;
    ...
    cout << "TString MPV_DATA = \"(" << fitDATA->GetParameter(0) << "+(" << fitDATA->GetParameter(1) << "*log10(BGO_EnergyG_SatCorr_ML_ions))" << "+(" << fitDATA->GetParameter(2) << "*pow(log10(BGO_EnergyG_SatCorr_ML_ions),2))" << "+(" << fitDATA->GetParameter(3) << "*pow(log10(BGO_EnergyG_SatCorr_ML_ions),3))" << "+(" << fitMC->GetParameter(4) << "*pow(log10(BGO_EnergyG_SatCorr_ML_ions),4))" << ")\";" << endl;
    ...
    legend->AddEntry(gmpv_data," DATA","lep");
    legend->AddEntry(gmpv_mc," MC","lep");
    legend->SetLineColor(0);
    legend->Draw();
    
    c1->SaveAs("plots/cfr_DATA_MC_SILICON_mpv.png");
