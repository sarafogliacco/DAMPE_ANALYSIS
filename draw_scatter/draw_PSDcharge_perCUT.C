{
	...
	TFile aa("/mnt/c/Users/saraf/Desktop/DAMPE_ANALYSIS/SULFUR_ANALYSIS/out_root/PSDcharge_perCUT_DATA_120months_SULFUR.root");
	...
	TH1F *hcut05 = hqpsdPathWeight_cut05->Clone(); 
	hcut05->SetLineWidth(3); hcut05->SetLineColor(col[0]);
	hcut05->Draw("same");
	...
	legend->AddEntry(hcut05,"PSD hits on YZ and XZ views","l");
    ...
    titAr = TLatex(); titAr.DrawLatex(18.7,9500.,"Ar");
    titAr.SetTextColor(1); titAr.SetTextSize(0.02); titAr.Draw();
