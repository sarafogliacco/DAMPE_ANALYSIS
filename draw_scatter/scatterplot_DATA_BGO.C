{
	...
	TFile *foutp = new TFile("/out_root/scatterplot_DATA_120months_PSD_BGO.root","RECREATE");
...
*/ 
	...
	TH2F *h2psdbgo = new TH2F("h2psdbgo","",noe,Ebin.data(),600,0.,30.); h2psdbgo->GetXaxis()->SetTitle("E_{BGO} (GeV)"); h2psdbgo->GetYaxis()->SetTitle("PSD charge ");
...
*/
	skim->Draw("PSD_PathWeighted_Charge:BGO_EnergyG_SatCorr_ML_ions2>>h2psdbgo",ctot,"");




	cout << " -------------------------------------------" << endl;
	cout << "           MIAO!  THIS IS THE END!          " << endl;
	cout << " -------------------------------------------" << endl;
