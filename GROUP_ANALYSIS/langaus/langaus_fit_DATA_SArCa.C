...
Int_t langaupro(Double_t *params, Double_t &maxx, Double_t &FWHM) {
   ...
   void langaus_fit_DATA_SArCa(){

   TFile *f = new TFile("/mnt/c/Users/saraf/Desktop/DAMPE_ANALYSIS/SULFUR_ANALYSIS/out_root/Skim_120months_SATcorr_STKcut1200_PSDcutXY_v3.root");
   ...
   if(j==1) {fr[0]=19.8; fr[1]=20.75;}
   if(j==2) {fr[0]=19.8; fr[1]=20.8;}
   if(j==3) {fr[0]=19.8; fr[1]=20.8;}
   if(j==4) {fr[0]=19.8; fr[1]=20.8;} 
   if(j==5) {fr[0]=19.8; fr[1]=20.9;}
   if(j==6) {fr[0]=19.8; fr[1]=20.9;}
   if(j==7) {fr[0]=19.7; fr[1]=21.2;}
   if(j==8) {fr[0]=19.8; fr[1]=21.5;}
   ...
   */
   ...
   xxx->GetYaxis()->SetTitleOffset(1.3); xxx->GetXaxis()->SetRangeUser(19.0,21.5);
...
/**/
   ofstream fout;
   fout.open("langaus_results/langaus_fit_DATA_CALCIUM_STKcut1200_PSDcutXY.txt",ios::app);
