...
void cfr_DATA_MC_sulfur_mpv(){
    ...
    ///////////////////////////////////// FLIGHT DATA
    ifstream infileDATA("langaus_results/results_langaus_fit_DATA_CALCIUM.txt");
    ...
    //TF1 *fitDATA = new TF1("fitDATA","[0]+[1]*log10(x)+[2]*log10(x)**2+[3]*log10(x)**3+[4]*log10(x)**4",100.,100000.);
