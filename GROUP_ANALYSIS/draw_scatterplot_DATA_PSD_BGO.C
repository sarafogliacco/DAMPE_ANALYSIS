{
    ...
    hDATA->GetYaxis()->SetRangeUser(15,22.5);
...
*/
    ...
    //TString MPV_DATA_s =  "(13.8877+(2.23861*log10(x))+(-0.724076*pow(log10(x),2))+(0.077887*pow(log10(x),3)))"; // MC corrected

    //"(14.5821+(1.51344*log10(x))+(-0.48318*pow(log10(x),2))+(0.0520877*pow(log10(x),3)))";
    ...
    TString sigma_DATA_s = "(0.231952+(0.0318629*log10(x)))";
    //TString sigma_DATA_s ="(0.1905+(0.0480417*log10(x)))"; // MC corrected


    //"(0.20977+(0.0478004*log10(x))+(-0.00269758*pow(log10(x),2)))";
    ...
    //TLatex *lat_S_up  = new TLatex(120.,17.0,"S MPV + 2.5#sigma"); lat_S_up->SetTextSize(0.027);  lat_S_up->Draw();
    ...
    */
    ...
    //slow_ar->SetLineColor(1); slow_ar->SetLineWidth(4); slow_ar->SetLineStyle(9); slow_ar->Draw("sa//me");
    ...
    //TLatex *lat_Ar_up  = new TLatex(120.,19.0,"Ar MPV + 2#sigma"); lat_Ar_up->SetTextSize(0.027);  lat_Ar_up->Draw();


    
    // CALCIUM *** 
    TString MPV_DATA_ca = "(17.1818+(2.97939*log10(x))+(-0.976515*pow(log10(x),2))+(0.10604*pow(log10(x),3)))";
    //"(20.024+(0.0595394*log10(x)))";
    TString sigma_DATA_ca = "(0.206041+(0.0693299*log10(x)))";

    TString cut_dw_ca = "1.5"; TString cut_up_ca = "2.0";
    ...
    //TLatex *lat_Ca_low = new TLatex(120.,19.8,"Ca MPV - 1.5#sigma"); lat_Ca_low->SetTextSize(0.027); lat_Ca_low->Draw();
    TLatex *lat_Ca     = new TLatex(220.,20.3,"Ca"); lat_Ca->SetTextSize(0.027); lat_Ca->Draw();
    TLatex *lat_Ca_up  = new TLatex(120.,21.1,"Ca MPV + 2#sigma"); lat_Ca_up->SetTextSize(0.027);  lat_Ca_up->Draw();



    TLatex *lat_Cl     = new TLatex(120.,17.2,"Cl"); lat_Cl->SetTextSize(0.027); lat_Cl->Draw();
    TLatex *lat_K     = new TLatex(120.,19.2,"K"); lat_K->SetTextSize(0.027); lat_K->Draw();
