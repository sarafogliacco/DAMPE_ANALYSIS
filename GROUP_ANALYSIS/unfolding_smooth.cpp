...
//const double livetime = 217488673.3 + 25087926.1;// 9 years +1
const double livetime = 242576599.4; // 10yrs
...
std::string fout_name = "unfold_results/unfold_results_flux_spectrum_SArCa_120months_6-4bin_smooth.root";
std::string fdat_name = "data/flux_spectrum_SArCa_120months_6-4bin_smooth.dat";
...
int unfolding_smooth() {
    ...
    std::string response_file = "../ARGON_ANALYSYS/load/out_load/Out_MC_FTFP_Ar_E2e7_6-4bin.root";
    std::string response_histo = "h2Ntrig_wgt";
    std::string data_file = "out_root/Out_DATA_120months_SArCa_6-4bin.root";
    ...
    std::ofstream outfile(fdat_name); //rimosso
    ...
    std::cout << "miao maio Results saved to "<< fout_name << std::endl;
    // Cleanup
    delete f;
    delete fdata;
    delete fout;
