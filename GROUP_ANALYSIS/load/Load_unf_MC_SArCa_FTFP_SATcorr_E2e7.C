{
	...
	*/
	...
	auto MPV_MC = [](double E){
    	double x = log10(E);
    	return 14.8272 + 1.92572*x - 0.568508*x*x + 0.0593389*x*x*x;
		//(14.976+(1.78884*x)+(-0.528537*x*x)+(0.0554816*x*x*x));
	...
	auto sigma_MC = [](double E){
    	double x = log10(E);
    	return 0.105133 + 0.0196781*x;
		//(0.0454068+(0.0415077*x)+(-0.00228883*x*x));
	...
	auto MPV_DATA = [](double E){
		...
		//(14.5821+(1.51344*x)+(-0.48318*x*x)+(0.0520877*x*x*x));
	...
	auto sigma_DATA = [](double E){
    	double x = log10(E);
    	return 0.231952 + 0.0318629*x;
		//(0.20977+(0.0478004*x)+(-0.00269758*x*x));
	...
	auto MPV_MC_CORR = [](double E){
    	double x = log10(E);
    	return 13.8831 + 2.24443*x - 0.726487*x*x + 0.0782163*x*x*x;
		//(15.0971+(1.00316*x)+(-0.323067*x*x)+(0.0374537*x*x*x));
		//14.8373+1.91533*x-0.566218*x*x+0.0591429*x*x*x;
	...
	auto sigma_MC_CORR = [](double E){
    	double x = log10(E);
    	return 0.231952 + 0.0318629*x;
		//(0.305322+(-0.0188628*x)+(0.00897858*x*x));
		//0.117412-0.00648231*x+0.00517629*x*x;
	...
	TFile *fout = new TFile("out_load/Out_MC_FTFP_S_E2e7_8-6-4bin_500TeV.root","RECREATE");
    ...
    // 
    TH1F *h00 = (TH1F*) p0->Get("h_energy_truth_8bins_weight_E2e7_cut_0"); // 100 GeV - 1 TeV
    TH1F *h01 = (TH1F*) p1->Get("h_energy_truth_6bins_weight_E2e7_cut_0"); // 1 TeV - 10 TeV
    TH1F *h02 = (TH1F*) p2->Get("h_energy_truth_4bins_weight_E2e7_cut_0");  // 10 TeV - 100 TeV
    TH1F *h03 = (TH1F*) p3->Get("h_energy_truth_4bins_weight_E2e7_cut_0");  // 100 TeV - 500 TeV
    ...
    h1Ngen->SetBinContent(1,  h00->GetBinContent(9)); // 100 GeV - 1 TeV
    h1Ngen->SetBinContent(2,  h00->GetBinContent(10));
    h1Ngen->SetBinContent(3,  h00->GetBinContent(11));
    h1Ngen->SetBinContent(4,  h00->GetBinContent(12));
    h1Ngen->SetBinContent(5,  h00->GetBinContent(13)); 
    h1Ngen->SetBinContent(6,  h00->GetBinContent(14));
	h1Ngen->SetBinContent(7,  h00->GetBinContent(15)); 
    h1Ngen->SetBinContent(8,  h00->GetBinContent(16)); 

    h1Ngen->SetBinContent(9,  h01->GetBinContent(13)); // 1 TeV - 10 TeV
    h1Ngen->SetBinContent(10, h01->GetBinContent(14));
    h1Ngen->SetBinContent(11, h01->GetBinContent(15)); 
    h1Ngen->SetBinContent(12, h01->GetBinContent(16)); 
    h1Ngen->SetBinContent(13, h01->GetBinContent(17)); 
	h1Ngen->SetBinContent(14, h01->GetBinContent(18)); 

	h1Ngen->SetBinContent(15, h02->GetBinContent(13)); // 10 TeV - 100 TeV
	h1Ngen->SetBinContent(16, h02->GetBinContent(14));
	h1Ngen->SetBinContent(17, h02->GetBinContent(15));
	h1Ngen->SetBinContent(18, h02->GetBinContent(16));   
    //h1Ngen->SetBinContent(17, h02->GetBinContent(23));    
    //h1Ngen->SetBinContent(18, h02->GetBinContent(24));

    h1Ngen->SetBinContent(19, h03->GetBinContent(17)); //100 TeV - 500 TeV
    h1Ngen->SetBinContent(20, h03->GetBinContent(18));
    h1Ngen->SetBinContent(21, h03->GetBinContent(19)); 
    h1Ngen->SetBinContent(22, h03->GetBinContent(20));
